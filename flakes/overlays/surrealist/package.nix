  ...
  bunDeps = stdenv.mkDerivation {
    ...
    buildPhase = ''
      ...
      ${lib.optionalString (stdenv.hostPlatform.system == "aarch64-linux") ''
        jq '.overrides.rollup = "npm:@rollup/wasm-node"' package.json | sponge package.json
      ''}
    ...
    outputHash =
      {
        ...
        aarch64-linux = "sha256-lxB5P2mHJnzXwuNsVE3UM754Mr7fwaL4dRFvpzqS6Ok=";
        x86_64-linux = "sha256-BdOmZkZL5MAKPMhZL7F5aHycSTGy4OGh5OpPAp4KvX0=";
      }
